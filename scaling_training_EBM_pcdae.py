...
def procedure_one(config, device, condition):
    ...
    print("ratio, seed, RMSE: ", ratio, seed, np.sqrt(test_T_loss), np.sqrt(test_Tadapt_loss))
        
    return (seed, ratio, test_init_loss, test_T_loss, test_Tadapt_loss, constant_init_loss, constant_T_loss, constant_Tadapt_loss)
...
if __name__ == "__main__":
    ...
    output_file = "results/scaling_training_ebm_pcdae_sine_V3.h5"
